...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">E<span class="text-warning">M</span>R</a>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img style="height:700px"
          src="https://www.nestle.co.id/sites/g/files/pydnoa241/files/Recycle%20Waste%20dan%20Perannya%20Terhadap%20Kelangsungan%20Bumi.jpg"
      ...
      <div class="carousel-item">
        <img style="height:700px"
          src="https://www.donegallive.ie/resizer/-1/-1/true/gn4/22926/GN4_DAT_22926646.jpg--.jpg" class="d-block w-100"
          alt="...">
        <div class="carousel-caption">
          <h5>Konservation</h5>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-12 col-12">
          <div class="about-img">
            <img src="picture/logo.jpg" alt="" class="img-fluid">
          </div>
        </div>
        <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
          <div class="about-text">
            <h2>About<br>Eco Manangement Recycle</h2>
  ...
  <section id="portfolio" class="pt-md-5">
    ...
    <div class="container">
      <div class="row">
        <div class="col-4">
          <div class="card">
            <img src="picture/portfolio/porto1.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="col-4">
          <div class="card">
            <img src="picture/portfolio/porto2.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="col-4">
          <div class="card">
            <img src="picture/portfolio/porto3.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="col-4 mt-md-4">
          <div class="card">
            <img src="picture/portfolio/porto4.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="col-4 mt-md-4">
          <div class="card">
            <img src="picture/portfolio/porto5.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="col-4 mt-md-4">
          <div class="card">
            <img src="picture/portfolio/porto6.jpg" class="card-img-top" alt="...">
            <div class="card-body">
